...
@external(javascript, "../queue_status_ffi.mjs", "mountQueueStatus")
fn mount(root: Dynamic, inner_id: String) -> Nil

pub const element_name: String = "audio-player-queue-status"

const inner_id: String = "apww-queue-status-root"
